...
//**Parse data */
async function lexer_exec(data:string, doc:string, func:boolean, infor?:boolean): Promise<void> {
    const init_word = data.split(" ")[0].trim();
    //String init
    if (init_word === "string") {
...
export { FUNCTION_DEF_STACK, STRTYPE_DEF_STACK, INTTYPE_DEF_STACK, IMPORT_DEF_STACK, ARRTYPE_DEF_STACK, RETURNSTACK_ARR, STDIN_ACTIVE_PREP_FEED };