...
async function method_init(content:string,doc:any,visibility:class_method_types,typarr:any):Promise<method_init_return>{
    ...
    const params:any = declaration.split(methodname.trim())[1].substring(1, declaration.split(methodname.trim())[1].length - 1);
...
export { class_init, master_class, class_master_creator, CLASS_TEMPORARY_DATA };